...
ASPP = 0
# from modeling_aspp import ViTMatte, MattingCriterion, Detail_Capture, ViT, ASPP
...
if ASPP:
    model = L(ViTMatte)(
        ...
        use_aspp = False,
        aspp = L(ASPP)(in_channel = embed_dim, out_channel = embed_dim),
        criterion=L(MattingCriterion)(
            losses = ['l1_loss', 'loss_pha_laplacian', 'loss_gradient_penalty']
        ),
