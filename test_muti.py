...
if __name__ == '__main__':
    ...
    #-------------test path-------------#
    parser.add_argument('--test_path', default="-",type=str, required=False)
    ...
    parser.add_argument('--matting_checkpoint', default="-",type=str, required=False)
    ...
    parser.add_argument('--sr_checkpoint', default="-",type=str, required=False)

    parser.add_argument('--sam_checkpoint', default="-",type=str, required=False)
